...
public class BeneficiaryParty {
	...
	/** The attributes. */
	@OneToOne(fetch=FetchType.LAZY, mappedBy = "beneficiaryParty")
	@JsonBackReference
	...
	public String toString() {
		return new ToStringBuilder(this).append("accountName", accountName).append("accountNumber", accountNumber)
				.append("accountNumberCode", accountNumberCode).append("accountType", accountType)
				.append("address", address).append("bankId", bankId).append("bankIdCode", bankIdCode)
	...
	public int hashCode() {
		return new HashCodeBuilder().append(accountNumber).append(accountName).append(address).append(name)
				.append(accountType).append(accountNumberCode).append(bankIdCode).append(bankId).toHashCode();
	}
	...
	public boolean equals(Object other) {
		...
		return new EqualsBuilder().append(accountNumber, rhs.accountNumber).append(accountName, rhs.accountName)
				.append(address, rhs.address).append(name, rhs.name).append(accountType, rhs.accountType)
				.append(accountNumberCode, rhs.accountNumberCode).append(bankIdCode, rhs.bankIdCode)
